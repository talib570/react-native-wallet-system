...
export const SKY = "rgb(164, 252, 239)";
export const CHECKED = "rgb(121, 79, 155)";
export const DARK_PURPL = "rgb(13, 1, 28)";
export const LT_APP = "rgb(110, 68, 106)";
export const DARK_APP = "rgb(66, 33, 64)";
export const DARK_GRAY = 'rgb(251,251,251)';
export const BLUE = 'rgb(64, 137, 255)';
